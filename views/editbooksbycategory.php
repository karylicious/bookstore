<html>
    <head>
        ...
        <script type="text/javascript">
            function toggle(){ 
                if(document.getElementById('search_form').style.visibility == 'visible'){
    ...
    <body style="padding: 20px;">	        
        <a href='index'>Home</a> > <a href='editbooks'>Edit Books</a> > <?php echo $category;?>         
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    if($listOfBooks != false){
                        ...
                        echo "<p style='margin-top:100px;'>There is no book.</p>";
                    }
                    ?>
                    </div>
                </div>
